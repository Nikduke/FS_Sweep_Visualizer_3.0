...
def main():
    ...
    with interactive_controls_area:
        plotly_selection_bridge(
            ...
            energinet_t2_default=float(ENERGINET_DEFAULT_THRESHOLDS[2]),
            energinet_t3_default=float(ENERGINET_DEFAULT_THRESHOLDS[3]),
            energinet_t4_default=float(ENERGINET_DEFAULT_THRESHOLDS[4]),
